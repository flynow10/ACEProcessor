...
void print_card(Card *card)
{
  ...
  setCurrentPos(lineStart + 80 * 2);
  printString("|       |", 0xffffff);
  setCurrentPos(lineStart + 80 * 3);
  printString("|   ", 0xffffff);
  switch (card->suit)
  {
  case 0:
  ...
  setCurrentPos(lineStart + 80 * 4);
  printString("|       |", 0xffffff);
  setCurrentPos(lineStart + 80 * 5);
  if (numChars == 1)
  {
    printString("|      ", 0xffffff);
  }
